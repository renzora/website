...
> **Only in Play or Simulate.** Every parkour system is gated on the simulation running, so a character sits exactly where you placed them while editing. Use **Play**, or **[Simulate](/docs/r1-alpha8/editor/viewport#simulate-mode)** to watch them move with the editor still live.
...
- [Physics](/docs/r1-alpha8/scripting/physics) — bodies, colliders, and the `move_controller` this replaces
- [Ragdoll Physics](/docs/r1-alpha8/scripting/ragdoll) — handing the same skeleton over to the solver
- [Animation](/docs/r1-alpha8/editor/animation) — clips, state machines and event markers
- [Scripting API](/docs/r1-alpha8/api/scripting) — the full function list
