...
Blueprints and text scripts ([Lua](/docs/r1-alpha8/scripting/lua)) are two front-ends onto one execution path:
...
The full per-node pin reference lives in the [Blueprint Node API](/docs/r1-alpha8/api/blueprint-nodes). To add your own node types, see [Custom Blueprint Nodes](/docs/r1-alpha8/extending/custom-nodes).
...
- [Scripting Overview](/docs/r1-alpha8/scripting/overview) — how scripts and blueprints fit together
- [Blueprint Node API](/docs/r1-alpha8/api/blueprint-nodes) — every node and its pins
- [Custom Blueprint Nodes](/docs/r1-alpha8/extending/custom-nodes) — register your own node types
