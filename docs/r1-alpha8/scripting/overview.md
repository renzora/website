...
> engine — see
> [Script Backends](/docs/r1-alpha8/extending/script-backends) if you want to
> bring your own.
...
browser — which opens it as a [document tab](/docs/r1-alpha8/editor/scenes#working-with-document-tabs)
...
- **[Scripting API](/docs/r1-alpha8/api/scripting)** — the complete function catalog.
