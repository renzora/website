...
There are a few more tags for repeating lists and reusing components. See the [Scripting API](/docs/r1-alpha8/api/scripting) for the full list.
...
The `value`, `data`, and `readout` fields accept live `{{ }}` bindings, so a fuel gauge or speedometer tracks your game in real time. For the full list of widget options, see the [Scripting API](/docs/r1-alpha8/api/scripting).
...
- [Scripting API](/docs/r1-alpha8/api/scripting) — the complete UI tag, binding, and widget reference.
