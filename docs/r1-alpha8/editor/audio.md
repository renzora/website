...
This page walks you through the basics. When you need the deep technical details, the [Scripting API](/docs/r1-alpha8/api/scripting) has the full reference.
...
There are more advanced options too — random clip pools, volume/pitch jitter, fades, and reverb. See the [Scripting API](/docs/r1-alpha8/api/scripting) for the complete list of fields.
...
For the full list of audio functions, see the [Lua scripting guide](/docs/r1-alpha8/scripting/lua) and the [Scripting API](/docs/r1-alpha8/api/scripting).
...
> Bus volumes are set here in the Mixer, not from scripts. Advanced users can also add effects (FX) to a bus — see the [Scripting API](/docs/r1-alpha8/api/scripting) for those features.
