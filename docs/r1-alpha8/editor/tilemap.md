...
Colliders use the **Avian 2D** physics backend (see [Physics](/docs/r1-alpha8/scripting/physics)); a character with a 2D body and collider will land on, slide along, and be blocked by the marked tiles once the game runs.
