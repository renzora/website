...
Terrain is serialized into the RON scene like any other entity (see [Scenes & Hierarchy](/docs/r1-alpha8/editor/scenes)). The meaningful, `Reflect`-serialized fields:
