...
- [Building from Source](/docs/r1-alpha8/setup/building-from-source) — the cargo aliases, runtime modes, and the one-binary/editor-as-cdylib model.
- [Building Export Templates](/docs/r1-alpha8/packaging/export-templates) — turning these builds into shippable game templates.
- [Asset Packing (rpak)](/docs/r1-alpha8/packaging/asset-packing) — how project assets are packed and shipped beside the binary.
