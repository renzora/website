...
- [Visual Blueprints](/docs/r1-alpha7/scripting/blueprints) — authoring graphs, and the compile-to-Lua model
- [Blueprint Node API](/docs/r1-alpha7/api/blueprint-nodes) — the 15 nodes that exist today
- [Scripting API](/docs/r1-alpha7/api/scripting) — everything your emission can call
