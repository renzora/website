...
[Script Backends](/docs/r1-alpha7/extending/script-backends) if you want to add a
language.
...
> see the [Lua reference](/docs/r1-alpha7/scripting/lua) and the
> [API catalog](/docs/r1-alpha7/api/scripting).
