...
- **Or add the node.** One `NodeEntry` plus a test is the whole job — see [Custom Blueprint Nodes](/docs/r1-alpha7/extending/custom-nodes).

## See also

- [Visual Blueprints](/docs/r1-alpha7/scripting/blueprints) — the editor and the execution model
- [Custom Blueprint Nodes](/docs/r1-alpha7/extending/custom-nodes) — adding to this list
- [Scripting API](/docs/r1-alpha7/api/scripting) — everything a node can compile down to
