...
- **Drag** a file onto a folder to move it, or out into the viewport to spawn it. Dragging a **scene** (`.bsn`) onto the viewport or the Hierarchy adds it as a nested **scene instance**.
