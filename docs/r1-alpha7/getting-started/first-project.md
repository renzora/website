...
When the editor starts you'll land on the [dashboard](/docs/r1-alpha7/getting-started/dashboard), open on its **Projects** page. Click **New Project** and choose a folder on your computer — the folder's name becomes the project's. (**New from Template** beside it starts you from a finished project instead; see the [dashboard](/docs/r1-alpha7/getting-started/dashboard#templates).) That's it — the editor builds the project and opens its starting scene, ready to go.
