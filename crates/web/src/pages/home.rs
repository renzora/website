        ...
        <section class="pt-28 pb-16 text-center px-6">
            <div class="max-w-2xl mx-auto">
                ...
                <div class="mt-9 flex gap-3 justify-center">
                    <a href="/download" class="inline-flex items-center justify-center px-5 py-2.5 rounded-lg text-sm font-medium bg-accent text-white hover:bg-accent-hover transition-colors">"Download"</a>
                    <a href="/docs" class="inline-flex items-center justify-center px-5 py-2.5 rounded-lg text-sm font-medium bg-surface-card text-zinc-50 border border-zinc-800 hover:border-zinc-600 transition-colors">"Documentation"</a>
                </div>
            ...
            <div class="max-w-[1200px] mx-auto px-6">
                <div class="text-center p-12 bg-surface-card border border-zinc-800 rounded-lg">
                    ...
                    <div class="flex gap-3 justify-center">
                        <a href="/download" class="inline-flex items-center justify-center px-5 py-2.5 rounded-lg text-sm font-medium bg-accent text-white hover:bg-accent-hover transition-colors">"Download"</a>
                        <a href="/docs/getting-started/installation" class="inline-flex items-center justify-center px-5 py-2.5 rounded-lg text-sm font-medium bg-surface-card text-zinc-50 border border-zinc-800 hover:border-zinc-600 transition-colors">"Getting Started Guide"</a>
                    </div>
                </div>
            </div>
        </section>
