    ...
    view! {
        ...
        <script>
            ...
            (async function() {
                ...
                // Gallery handled by embed iframe
                ...
                // Gallery/thumbs handled by embed iframe
                ...
                el.innerHTML = `
                    ...
                    <div class="flex flex-col lg:flex-row gap-8">
                        <div class="flex-1 min-w-0">
                            <!-- Preview via embed component -->
                            <div class="rounded-2xl overflow-hidden border border-zinc-800/50 bg-zinc-900">
                                <iframe src="/embed/preview/${a.slug}" class="w-full aspect-video border-0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                            </div>

                            ${(() => { return ''; // preview handled by embed
