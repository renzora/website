        ...
        <section class="py-12 px-6 min-h-[80vh] bg-gradient-to-b from-[#0c0a10] via-[#060608] to-[#060608]">
            <div class="max-w-[1000px] mx-auto">
                <div class="flex justify-between items-start mb-8">
                    ...
                    <a href="/articles/write" class="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg text-sm font-medium bg-accent text-white hover:bg-accent-hover transition-colors">
            ...
            async function loadArticles(tag, page) {
                ...
                try {
                    ...
                    el.innerHTML = data.articles.map(a => {
                        ...
                        return `
                        <a href="/articles/${a.slug}" class="block group">
    ...
    view! {
        ...
        <script>
            ...
            (async function() {
                ...
                el.innerHTML = `
                    <a href="/articles" class="inline-flex items-center gap-1 text-xs text-zinc-500 hover:text-zinc-300 transition-colors mb-6">
...
pub fn WriteArticlePage() -> impl IntoView {
    view! {
        ...
        <section class="py-12 px-6">
            <div class="max-w-[800px] mx-auto">
                <a href="/articles" class="inline-flex items-center gap-1 text-xs text-zinc-500 hover:text-zinc-300 transition-colors mb-4">
                    <i class="ph ph-arrow-left"></i>"Back to Articles"
                </a>
