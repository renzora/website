...
async fn main() {
    ...
    let app = Router::new()
        ...
        .route("/marketplace/asset/:slug/releases/new", get(ssr.clone()))
        .route("/marketplace/asset/:slug/files", get(ssr.clone()))
        .route("/marketplace/asset/:slug/files/*path", get(ssr.clone()))
